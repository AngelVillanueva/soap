...
# variable definition
# log file
readonly mlog=log_public_content_tests.json
# default db socket for MAMP
readonly local_socket="/Applications/MAMP/tmp/mysql/mysql.sock"
# phpunit configuration file
readonly config_file=../components/com_content/Tests/phpunit.xml
# tests to be run
readonly testSuite=../components/com_content/Tests/.
